      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><Link className="dropdown-item" to={'hiphopforkids'}>HipHop for Kids</Link></li>
            <li><Link className="dropdown-item" to={'hiphopforadults'}>HipHop for Adults</Link></li>
            <li><hr className="dropdown-divider"/></li>
            <li><Link className="dropdown-item" to={'modernjazz'}>Modern Jazz</Link></li>
          </ul>
        </li>
        <li className="nav-item">
